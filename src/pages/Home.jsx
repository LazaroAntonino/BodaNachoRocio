	...
	const textos = {
		...
		asistencia: (
			<div className="asistencia-textos">
				...
				<p>¡Atención, atención! Este apartado es, probablemente, el más importante. Queremos verte ahí, queremos compartir todo esto contigo y queremos que, para ti, también sea un día que no olvides. Pero todo eso empieza porque nos confirmes tu asistencia y otros detalles mediante el formulario que encontrarás haciendo click en</p>
				<a href="#confirmar-asistencia" className="btn btn-primary mt-2">CONFIRMAR MI ASISTENCIA</a>
			</div>
		),
		horarios: (
