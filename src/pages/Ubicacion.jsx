...
const Ubicacion = () => (
  ...
  <div className="ratio ratio-16x9 mb-3" style={{borderRadius: '1.5rem', overflow: 'hidden', boxShadow: '0 2px 16px #b3cbe622', marginBottom:'1.2rem'}}>
      <iframe
