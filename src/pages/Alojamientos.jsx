...
const Alojamientos = () => (
  <div className="alojamientos-textos" style={{
    ...
    <ul style={{
      ...
      <li style={{textAlign:'center'}}>
        <a href="https://drive.google.com/file/d/1ZFbyFuT69IcsjKFk2kvXdau07LLXWWpi/view?usp=sharing" target="_blank" rel="noopener noreferrer" style={{color:'#1B5583', fontWeight:600, textDecoration:'underline'}}>Hoteles en Jávea y cerca de la finca</a>
      </li>
    </ul>
    {/*
